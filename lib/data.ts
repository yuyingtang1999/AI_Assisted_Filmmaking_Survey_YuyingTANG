...
export interface Paper {
  ...
  sites?: SiteId[]; // for cross-site papers: the specific labor sites covered
...
export const PAPERS: Paper[] = [
  ...
  { id: 30, name: "Paratrouper", venue: "CHI", year: 2025, url: "https://dl.acm.org/doi/10.1145/3706598.3714242", site: "cross", sites: ["atl-ind", "btl-ind", "btl-grp"], laborTypes: ["Executional", "Structural", "Meaning-Making"], human: ["Executional", "Structural", "Meaning-Making"], ai: ["Executional", "Structural"], allocation: { "Executional": "HA", "Structural": "HA", "Meaning-Making": "Human Only" }, desc: "Exploratory creation of character-cast visuals using generative AI, spanning ATL-individual, BTL-individual, and BTL-group sites via early reference artifacts.", benefit: "Supports cross-role alignment and coherent cast design through parallel multi-character exploration.", challenge: "Better suited to early exploration than precise downstream production, due to limited fine-grained control.", tag: "Latest, cross-site work" },
  { id: 31, name: "Understanding Creative Potential", venue: "IMX", year: 2025, url: "https://dl.acm.org/doi/10.1145/3706370.3727853", site: "cross", sites: ["atl-ind", "atl-grp", "btl-ind", "btl-grp"], laborTypes: ["Executional", "Structural", "Meaning-Making"], human: ["Executional", "Structural", "Meaning-Making"], ai: ["Executional"], allocation: { "Executional": "HA", "Structural": "Human Only", "Meaning-Making": "Human Only" }, desc: "AI-generated environments for virtual film production, supporting all four labor sites with cross-department feasibility testing.", benefit: "Broadens environment inspection and previs across ATL and BTL roles, enabling faster creative judgment and shared review.", challenge: "Limited interactivity and customization can misfit different labor-site needs.", tag: "Latest, cross-site work" },
];
// ---------------------------------------------------------------------------
