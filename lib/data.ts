...
export const SITES: SiteMeta[] = [
  ...
  { id: "cross", label: "Cross-Site", short: "Cross-Site", atl: false, group: true, accent: "#8a8f98", soft: "#eef0f2", roles: "Spanning ATL & BTL roles", focus: "Intent translation across stages & roles", count: 2, pct: "6.5%" },
];
...
export const TYPES: TypeMeta[] = [
  { id: "Executional", color: "#c75b39", soft: "rgba(199,91,57,0.14)", definition: "Content-level actions that directly change the artifact's material state.", actions: "Generate, edit, transform, render / export", evolution: "The stable core: always in scope, and the first labor AI learned to accelerate." },
